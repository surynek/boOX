...
/*                                                                            */
/*============================================================================*/
/* randgen_main.cpp / 1-224_leibniz                                           */
/*----------------------------------------------------------------------------*/
//
//
...
/*----------------------------------------------------------------------------*/
    ...
    {
	printf("----------------------------------------------------------------\n");
	printf("%s : Random Instance Generator\n", sPRODUCT);
	printf("%s\n", sCOPYRIGHT);
	printf("================================================================\n");	
    }
    ...
    {
	printf("Usage:\n");
	printf("randgen_boOX  --N-vertices=<int>\n");
	printf("              --N-agents=<int>\n");
	printf("             [--edge-probability=<double>]\n");
	printf("             [--walk]\n");		
	printf("             [--seed=<int>\n");
	...
	printf("\n");
	printf("Examples:\n");
	printf("randgen_boOX --N-vertices=10\n");
	printf("             --N-agents=5\n");
	printf("             --seed=12345\n");
	printf("             --edge-probability=0.1\n");
	...
	{       
	    ...
	    {
		environment = sUndirectedGraph(parameters.m_N_vertices, parameters.m_edge_probability);
	    }
	...
	else if (parameter.find("--edge-probability=") == 0)
	{
	    command_parameters.m_edge_probability = sDouble_from_String(parameter.substr(19, parameter.size()));
	}
	...
	{
	    return sRANDGEN_PROGRAM_UNRECOGNIZED_PARAMETER_ERROR;
	}
	return sRESULT_SUCCESS;
    }
...
int main(int argc, char **argv)
{
	...
	result = generate_RandomInstance(command_parameters);
	if (sFAILED(result))
	{
	    return result;
	}

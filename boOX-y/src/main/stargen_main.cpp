...
/*                                                                            */
/*============================================================================*/
/* stargen_main.cpp / 1-224_leibniz                                           */
/*----------------------------------------------------------------------------*/
//
//
// Star Graph Instance Generator - main program.
//
// Generates a Multi Robot instance on a starom graph.
//
/*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------*/
    ...
    {
	printf("----------------------------------------------------------------\n");
	printf("%s : Star Instance Generator\n", sPRODUCT);
	printf("%s\n", sCOPYRIGHT);
	printf("================================================================\n");	
    }
    ...
    {
	printf("Usage:\n");
	printf("stargen_boOX  --N-vertices=<int>\n");
	printf("              --N-agents=<int>\n");
	printf("             [--walk]\n");		
	printf("             [--seed=<int>\n");
	...
	printf("\n");
	printf("Examples:\n");
	printf("stargen_boOX --N-vertices=10\n");
	printf("             --N-agents=5\n");
	printf("             --seed=12345\n");
	...
	{       
	    ...
	    {
		environment.generate_Star(parameters.m_N_vertices);
	    }
	...
	{
	    return sSTARGEN_PROGRAM_UNRECOGNIZED_PARAMETER_ERROR;
	}
	return sRESULT_SUCCESS;
    }
...
int main(int argc, char **argv)
{
	...
	result = generate_StarInstance(command_parameters);
	if (sFAILED(result))
	{
	    return result;
	}

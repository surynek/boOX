...
/*                                                                            */
/*============================================================================*/
/* swap_solver_main.cpp / 2-203_planck                                        */
/*----------------------------------------------------------------------------*/
//
...
/*----------------------------------------------------------------------------*/
	...
	case sCommandParameters::ALGORITHM_CBS:
	{
	    ...
	    cost = cbs_Solver.find_ShortestNonconflictingSwapping(solution, parameters.m_cost_limit);
	    break;
	}
	case sCommandParameters::ALGORITHM_CBS_PLUS:
	{
	    ...
	    sCBS cbs_Solver(&instance, parameters.m_timeout);
	    cost = cbs_Solver.find_ShortestNonconflictingSwapping_Delta(solution, parameters.m_cost_limit);	    
	    break;
	}
	case sCommandParameters::ALGORITHM_CBS_PLUS_PLUS:
	{
	    ...
	    sCBS cbs_Solver(&instance, parameters.m_timeout);
	    cost = cbs_Solver.find_ShortestNonconflictingSwapping_DeltaStar(solution, parameters.m_cost_limit);	    
	    break;
	}
	case sCommandParameters::ALGORITHM_CBS_PLUS_PLUS_PLUS:
	{
	    ...
	    sCBS cbs_Solver(&instance, parameters.m_timeout);
	    cost = cbs_Solver.find_ShortestNonconflictingSwapping_DeltaSuperStar(solution, parameters.m_cost_limit);	    
	    break;
	}			

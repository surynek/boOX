...
/*                                                                            */
/*============================================================================*/
/* swap_solver_main.cpp / 3-007_godel                                         */
/*----------------------------------------------------------------------------*/
//
...
#include "main/swap_solver_main.h"
...
/*----------------------------------------------------------------------------*/
	...
	case sCommandParameters::ALGORITHM_CBS:
	{
	    ...
	    cost.first = cbs_Solver.find_ShortestNonconflictingSwapping(solution, parameters.m_cost_limit);
	    break;
	}
	case sCommandParameters::ALGORITHM_CBS_PLUS:
	{
	    ...
	    sCBS cbs_Solver(&instance, parameters.m_timeout);
	    cost.first = cbs_Solver.find_ShortestNonconflictingSwapping_Delta(solution, parameters.m_cost_limit);	    
	    break;
	}
	case sCommandParameters::ALGORITHM_CBS_PLUS_PLUS:
	{
	    ...
	    sCBS cbs_Solver(&instance, parameters.m_timeout);
	    cost.first = cbs_Solver.find_ShortestNonconflictingSwapping_DeltaStar(solution, parameters.m_cost_limit);	    
	    break;
	}
	case sCommandParameters::ALGORITHM_CBS_PLUS_PLUS_PLUS:
	{
	    ...
	    sCBS cbs_Solver(&instance, parameters.m_timeout);
	    cost.first = cbs_Solver.find_ShortestNonconflictingSwapping_DeltaSuperStar(solution, parameters.m_cost_limit);	    
	    break;
	}			
	case sCommandParameters::ALGORITHM_SMTCBS:
	{
	    ...
	    cost = smtcbs_Solver.find_ShortestNonconflictingSwapping(solution, parameters.m_cost_limit);
	    break;
	}
	case sCommandParameters::ALGORITHM_SMTCBS_PLUS:
	{
	    ...
	    sBoolEncoder encoder;
	    sSMTCBS smtcbs_Solver(&encoder, parameters.m_subopt_ratio, &instance, parameters.m_timeout);	    	    
	    cost = smtcbs_Solver.find_ShortestNonconflictingSwappingInverse(solution, parameters.m_cost_limit);
	    break;
	}
	case sCommandParameters::ALGORITHM_SMTCBS_PLUS_PLUS:
	{
	    ...
	    sBoolEncoder encoder;
	    sSMTCBS smtcbs_Solver(&encoder, parameters.m_subopt_ratio, &instance, parameters.m_timeout);	    	    	    
	    cost = smtcbs_Solver.find_ShortestNonconflictingSwappingInverseDepleted(solution, parameters.m_cost_limit);
	    break;
	}
	case sCommandParameters::ALGORITHM_SMTCBS_PLUS_PLUS_PLUS:
	{
	    ...
	    sBoolEncoder encoder;
	    sSMTCBS smtcbs_Solver(&encoder, parameters.m_subopt_ratio, &instance, parameters.m_timeout);	    	    	    
	    cost = smtcbs_Solver.find_ShortestNonconflictingSwappingInverseOmitted(solution, parameters.m_cost_limit);
	    break;
	}			
	default:
	{
...
int main(int argc, char **argv)
{
	...
	{
	    printf("Error: Input file name missing (code = %d).\n", sSWAP_SOLVER_PROGRAM_MISSING_INPUT_FILE_ERROR);
	    return sSWAP_SOLVER_PROGRAM_MISSING_INPUT_FILE_ERROR;
	}		

...
do
	...
	../main/moviscen_convert_boOX '--input-movi-map-file='$PREFIX'.map' '--input-movi-scen-file='$SCENARIO_PREFIX'-'$SCENARIO'.scen' '--output-lcbs-file='$PREFIX'-'$SCENARIO'_a'$ROBOTS'.lcbs' '--N-agents='$ROBOTS
    done
done

...
do
	...
	../main/moviscen_convert_boOX '--input-movi-map-file='$PREFIX'.map' '--input-movi-scen-file='$SCENARIO_PREFIX'-'$SCENARIO'.scen' '--output-mpf-file='$PREFIX'-'$SCENARIO'_a'$ROBOTS'.mpf' '--N-agents='$ROBOTS
    done
done

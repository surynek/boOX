...
do
    ...
    ../../main/rota_solver_boOX '--timeout='$TIMEOUT  '--input-file='$PREFIX'-'$SCENARIO'_a'$AGENTS'_u'$UNASSIGNED'.npf' '--algorithm=nrfsat' '--output-file=solution_'$PREFIX'-'$SCENARIO'_a'$AGENTS'_u'$UNASSIGNED'.txt' > 'out_'$PREFIX'-'$SCENARIO'_a'$AGENTS'_u'$UNASSIGNED'.txt'
done
